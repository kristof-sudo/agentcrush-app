...
const DISCOVERY = {
  ...
  service: {
    ...
    url: 'https://agentcrush.ai',
    seller: '0x58e632Fa698383820FFC22156352C9836790E2c0',
    network: 'eip155:8453',
  },
  resources: [
    {
      url: 'https://agentcrush.ai/api/agent/:handle/trust-summary',
      method: 'GET',
      description:
    ...
    {
      url: 'https://agentcrush.ai/api/agent/:handle/history',
      method: 'GET',
      description:
    ...
    {
      url: 'https://agentcrush.ai/api/agent/:handle/verification-status',
      method: 'GET',
      description:
