...
const SECTIONS = [
  {
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          Today over 130 agents are evidence-ranked and over 1,390 are indexed. Both counts grow automatically
        ...
        <div className="mt-4 space-y-3">
          {[
            ...
            },
            {
              ...
              desc: 'Tracked and discoverable in /explore, but does not yet meet the evidence threshold for /rankings. Over 1,390 agents are indexed today. Coverage is live and growing.',
            },
            {
              value: 'archived',
    ...
    <main className="mx-auto max-w-3xl px-4 py-12 md:px-6">
      <div className="mb-6 rounded-xl border border-[rgba(0,212,255,0.20)] bg-[rgba(0,212,255,0.04)] px-4 py-3">
        <p className="text-xs text-white/70 leading-relaxed">
          ...
          This page covers the <strong>developer-agent universal ranking methodology (v2.c-public)</strong>. AgentCrush also has per-category methodologies for <Link href="/rankings/model-families" className="text-[#00d4ff] hover:text-cyan-300 underline underline-offset-2">model families</Link>, <Link href="/rankings/tokenized-agents" className="text-[#00d4ff] hover:text-cyan-300 underline underline-offset-2">tokenized agents</Link>, <Link href="/rankings/service-agents" className="text-[#00d4ff] hover:text-cyan-300 underline underline-offset-2">service agents</Link>, and <Link href="/rankings/mcp-servers" className="text-[#00d4ff] hover:text-cyan-300 underline underline-offset-2">MCP servers</Link>. The full hub is at <Link href="/methodology" className="text-[#00d4ff] hover:text-cyan-300 underline underline-offset-2 font-semibold">/methodology</Link>.
        </p>
      </div>
