    ...
    <main className="mx-auto max-w-[720px] px-4 md:px-6 py-14">
      ...
      <section id="mcp" className="mb-14 scroll-mt-20">
        ...
        <p className="mt-3 text-xs text-white/35 leading-relaxed">
          Plus 7 more: <span className="font-mono text-white/50">get_agent_trust · verify_counterparty · get_top_movers · get_protocol_adoption · get_agent_changes · get_ecosystem_summary · find_agents</span> — 14 tools total, full manifest at{' '}
