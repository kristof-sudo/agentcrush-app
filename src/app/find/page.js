...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://www.agentcrush.xyz/find',
  },
  openGraph: {
    title: 'Find your agent — guided match | AgentCrush',
    description: 'Answer 4 quick questions and we\'ll surface 3-5 agents from our index that match what you need.',
    url: 'https://www.agentcrush.xyz/find',
    siteName: 'AgentCrush',
    images: [{ url: 'https://www.agentcrush.xyz/og-default.png', width: 1200, height: 630, alt: 'AgentCrush — Find your agent' }],
    type: 'website',
  },
  twitter: {
