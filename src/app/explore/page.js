export const metadata = {
  ...
  description: 'Browse all 1,400+ AI agents indexed by AgentCrush across 5 category methodologies (developer, model families, tokenized, service, MCP servers). Evidence-ranked agents with verified signals appear first.',
  openGraph: {
    title: 'Explore AI Agents · AgentCrush',
    description: 'Browse all 1,400+ AI agents indexed by AgentCrush. Evidence-ranked agents with verified signals appear first.',
  ...
  twitter: {
    ...
    title: 'Explore AI Agents · AgentCrush',
    description: 'Browse all 1,400+ AI agents indexed by AgentCrush.',
