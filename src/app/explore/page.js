export const metadata = {
  ...
  description: 'Browse all 1,300+ AI agents indexed by AgentCrush across 4 category methodologies (model families, tokenized, service, developer). Evidence-ranked agents with verified signals appear first.',
  openGraph: {
    title: 'Explore AI Agents · AgentCrush',
    description: 'Browse all 1,300+ AI agents indexed by AgentCrush. Evidence-ranked agents with verified signals appear first.',
  ...
  twitter: {
    ...
    title: 'Explore AI Agents · AgentCrush',
    description: 'Browse all 1,300+ AI agents indexed by AgentCrush.',
