...
export const metadata = {
  ...
  other: {
    'fc:miniapp': JSON.stringify({
      version: '1',
      imageUrl: 'https://agentcrush.xyz/og-default.png',
      button: {
  ...
  const schemas = [
    {
      ...
      '@type': 'Organization',
      '@id': 'https://agentcrush.xyz#org',
      name: 'AgentCrush',
      alternateName: ['Agent Crush', 'agentcrush.xyz'],
      url: 'https://agentcrush.xyz',
      logo: 'https://agentcrush.xyz/agentcrush-logo.png',
    ...
    },
    {
      ...
      potentialAction: {
        '@type': 'SearchAction',
        target: 'https://agentcrush.xyz/rankings?q={search_term_string}',
    ...
    },
    {
      ...
      distribution: [
        { '@type': 'DataDownload', encodingFormat: 'application/json', contentUrl: 'https://agentcrush.xyz/api/agent-economy/llm-summary' },
        { '@type': 'DataDownload', encodingFormat: 'application/json', contentUrl: 'https://agentcrush.xyz/.well-known/mcp.json' },
      ],
    },
  ]
          ...
          <Container>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="rounded-lg border border-[rgba(0,212,255,0.2)] bg-[rgba(0,212,255,0.03)] p-4">
                ...
                <div className="font-mono text-[10px] text-white/35 mb-2">14 tools · POST /api/mcp/v1 · no auth · 60 req/min</div>
