...
const TRACKED_SURFACES = [
  ...
  { name: 'x402 endpoints / Bazaar',                status: 'Collecting', note: 'AgentCrush endpoints live; Bazaar index visibility pending' },
  ...
  { name: 'A2A / MCP activity',                     status: 'Monitoring', note: 'protocol coverage in scope; full ingestion not started' },
