...
const STATIC_PAGES = [
  ...
  { path: '/rankings/service-agents',   priority: 0.8, changeFrequency: 'daily'  },
  ...
  { path: '/agent-payments-stack',  priority: 0.9, changeFrequency: 'weekly' },
  ...
  { path: '/blog/agent-payments-stack-live', priority: 0.6, changeFrequency: 'monthly'},
  ...
  { path: '/rankings/agent-payments-stack', priority: 0.8, changeFrequency: 'weekly'},
